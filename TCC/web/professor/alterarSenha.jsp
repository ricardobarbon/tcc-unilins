...
<html>
    ...
    <table width="100%">
        <tr> <td width="18%" valign="top"> <%@include file="/menuProfessor.htm" %> <td valign="top"><img src="Imagens/pagProfessor/headerAlterarSenha.jpg"><br>
        <br><br>
		<table width="100%"  border="0"><form action="SalvarNovaSenhaProf" method="post">
  <tr>
  ...
  <tr>
    <td>&nbsp;</td>
        <td width="11%"><input type="submit" value="Concluir"></form></td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<td><form action="meuCadastroProf" method="get"><input type="submit" value="Cancelar"></form>
