...
<html>
    ...
    <table width="100%">
        <tr> <td width="18%" valign="top"> <%@include file="/menuAudio.htm" %> <td valign="top"><img src="Imagens/pagAudio/headerCancelarReserva.jpg"><br>
		<br><br><br>
		<h2><Center>Tem certeza que deseja cancelar a reserva?</Center></h2><br><br><br>
