...
<html>
    <head>
        ...
        <title>&laquo; Imprimir Lembretes - SisCRE &raquo</title>
    </head>
    <body>
    ...
    <table width="100%">
        <tr> <td width="18%" valign="top"> <%@include file="/menuAudio.htm" %> <td valign="top"><img src="Imagens/pagAudio/headerImprimirLembretes.jpg"><br>
    <table  width="100%" border="0"><form action="" method="post">
		<tr><td colspan="2"><br><br><br>
		<h2><center>
		  Imprimir Lembretes de Professor, de que dia?
		</center></h2>
