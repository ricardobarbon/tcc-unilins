...
<html>
    ...
    <table width="100%">
        ...
        <table width="100%"  border="0"><form action="UsuarioAtualizar" method="post">
  <% String id = (String)request.getAttribute("id");
      ...
      String usuarioTipo = (String)request.getAttribute("usuarioTipo");
  ...
  <tr>
      <td align="right"><b>Data Nascimento: </b></td>
       ...
       <td><% if(usuarioTipo.compareToIgnoreCase("ADMINISTRADOR")==0){
          out.println("<select name=\"tipo\">");
          out.println("<option value=\"ADMINISTRADOR\" selected>ADMINISTRADOR</option>");
          out.println("<option value=\"AUDIOVISUAL\">AUDIOVISUAL</option>");
          out.println("<option value=\"SECRETARIA\">SECRETARIA</option>");
          out.println("</select>");
          }
          else if(usuarioTipo.compareToIgnoreCase("AUDIOVISUAL")==0){
          out.println("<select name=\"tipo\">");
          out.println("<option value=\"ADMINISTRADOR\">ADMINISTRADOR</option>");
          out.println("<option value=\"AUDIOVISUAL\" selected>AUDIOVISUAL</option>");
          out.println("<option value=\"SECRETARIA\">SECRETARIA</option>");
          out.println("</select>");
          }
          else{
          ...
          out.println("<option value=\"ADMINISTRADOR\">ADMINISTRADOR</option>");
          out.println("<option value=\"AUDIOVISUAL\">AUDIOVISUAL</option>");
          out.println("<option value=\"SECRETARIA\" selected>SECRETARIA</option>");
          out.println("</select>");
      }%></td>
  </tr>
  <tr>
