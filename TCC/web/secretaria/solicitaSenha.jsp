...
<html>
    ...
    <table width="100%">
        <tr> <td width="18%"> <%@include file="/menuSecretaria.htm" %> <td valign="top"><img src="Imagens/pagProfessor/headerInformeSenha.jpg"><br>
        ...
        <input name="entrar" type="submit" value="Entrar"></form></center></h2>
    </table>
