...
<html>
    <head>
        ...
        <title>&laquo; Consultar Professor - SisCRE &raquo;</title>
    </head>
    <body>
    ...
    <table width="100%">
        <tr> <td width="18%" valign="top"> <%@include file="/menuSecretaria.htm" %> <td valign="top"><img src="Imagens/pagSecretaria/headerConsultaProfessor.jpg"><br>
		<table width="100%"  border="0">
         ...
         <tr>
            <td colspan="2">&nbsp;</td>
            <td><form action="professorAlterar" method="post"><input type="submit" value=Alterar></form></td>
            <td><form action="professorExcluir" method="post"><input type="submit" value=Excluir></form></td>
         </tr>
