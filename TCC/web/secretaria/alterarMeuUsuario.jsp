...
<html>
    <head>
        ...
        <title>&laquo; Alterar Meu Usuário - SisCRE &raquo;</title>
    </head>
    <body>
    ...
    <table width="100%">
        <tr> <td width="18%" valign="top"> <%@include file="/menuSecretaria.htm" %> <td valign="top"><img src="Imagens/pagSecretaria/headerAlterarMeuUsuario.jpg"><br>
